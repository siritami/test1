...
wget -nv -O "./download/ChromeXt-signed.apk" --header="User-Agent: Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.6099.231 Mobile Safari/537.36" "https://github.com/JingMatrix/ChromeXt/releases/download/v3.8.2/ChromeXt-signed.apk"
...
mv ./chrome*.apk ./release/chrome-beta-ChromeXt.apk
